        ...
        let render = data && data.length != 0 ? data.map((doc) => {
            return (
                <div className="payment-content">
                    ...
                    <h2 className="font-color-blue">{doc.paid}</h2>
            ...
            <div className="test">
                ...
                <div className="img">
                    ...
                    <div className="nav" id="trans" style={{opacity: this.state.opacity}}>
                        ...
                        <div className="buttonNav">
                            <Button style={{marginBottom : "10px"}} onClick = {e=>this.props.history.push(`/users/${this.state.data ? this.state.data_id : ""}`)}>Home</Button>
                ...
                <div>
                    <div className="modal-content">
                        ...
                        <div className="normal-content" style={{ borderTopStyle: "dashed", borderColor: "rgb(255, 104, 69,1)" }}>
                            <h2 className="title font-color-blue">Debts</h2>
                            <div className="debt-div">
                                <ul style={{listStyle: "none"}}>
                                    {this.state.debt ? this.state.debt.map((doc) => {
                                        return <li className="font-color-blue name" style={{width: 700}}> {doc.payer} owes {doc.payee} {doc.amount} </li>
                                    }) : ""}
                                </ul>
